 ...
 *         &lt;element name="_SendDate" type="{http://localhost:4434/tender}DateTime"/&gt;
 *         &lt;element name="OpenDateTime" type="{http://localhost:4434/tender}DateTime"/&gt;
 *         &lt;element name="EvalEnd" type="{http://localhost:4434/tender}DateTime"/&gt;
 *         &lt;element name="_PartCompDateTime" type="{http://localhost:4434/tender}DateTime"/&gt;
 *         &lt;element name="_ApplyPeriodStart" type="{http://localhost:4434/tender}DateTime"/&gt;
 *         &lt;element name="_ApplyPeriodEnd" type="{http://localhost:4434/tender}DateTime"/&gt;
 ...
 *         &lt;element name="ag_dauer_spanne_beginn" type="{http://localhost:4434/tender}DateTime"/&gt;
 *         &lt;element name="ag_dauer_spanne_ende" type="{http://localhost:4434/tender}DateTime"/&gt;
 *         &lt;element name="_OfferDeadline" type="{http://localhost:4434/tender}DateTime"/&gt;
 ...
 *         &lt;element name="frist_schriftl_anfragen" type="{http://localhost:4434/tender}DateTime"/&gt;
 *         &lt;element name="frist_schrift_frag_tnw_folgend" type="{http://localhost:4434/tender}DateTime"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
